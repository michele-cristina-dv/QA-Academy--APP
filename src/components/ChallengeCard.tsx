...
const ChallengeCard = ({ challenge, onStart }: ChallengeCardProps) => {
  ...
  return (
    <Card className="p-6 bg-gradient-to-br from-white to-gray-50 border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
      ...
      <div className="flex items-center justify-between text-sm text-gray-500 mb-4">
        ...
        <div className="flex items-center space-x-1">
          ...
          <span>{challenge.completedBy} completaram</span>
        </div>
      </div>
